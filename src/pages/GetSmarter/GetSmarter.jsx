        ...
        <div className="benefits__list">
          <div className="benefits__benefit benefit">
            ...
            <div className="benefit__info-container">
              ...
              <p className="benefit__subtitle">
                Highlighted by top reviewers, we picked only
                the most outstanding bestsellers for you.
              </p>
            </div>
          </div>
          ...
          <div className="benefits__benefit benefit">
            ...
            <div className="benefit__info-container">
              ...
              <p className="benefit__subtitle">
                Consistency is the key to top performance. Only
                15 minutes per day to make reading your brand new habit!
              </p>
            </div>
          </div>
        </div>
