        ...
        <div className="comments__list">
          <div className="comments__item item">
            ...
            <div className="item__comment">
              ...
              snippets. Listened to almost all of the Art of Saying No during
              my warm up/stretch sesh today. A powerful tool I recommend to
              anyone who’s busy and can’t find time to sit down to read!
            </div>
          ...
          <div className="comments__item item">
            ...
            />
            <div className="item__comment">
              Headway app is one of the best investments I’ve ever made
              into myself outside of spiritual stuff. Summarized books
          ...
          <div className="comments__item item">
            ...
            />
            <div className="item__comment">
              In case you often find a book you just started — the Headway
              app is for you. It’s an audiobook reader that summarized all
              the key lessons in that great book you’ve been aspiring to read,
          ...
          <div className="comments__item item">
            ...
            />
            <div className="item__comment">
              So excited for my latest app subscription for self-growth!
              You can set reading goals, take challenges or read offline!
              <span role="img"> 🤓</span>
            </div>
            <div className="item__user-info user">
              <img
